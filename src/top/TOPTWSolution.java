...
public class TOPTWSolution {
    ...
    /**
     * @brief Constructor de TOPTWSolution en base a un problema TOPTW
     * @param problem
     */
    public TOPTWSolution(TOPTW problem) {
        ...
        this.objectiveFunctionValue = -1.0;
    }
    /**
     * @brief metodo para iniciar la solucion
     * @return void
     */
    ...
    public boolean equals(Object otherSolution) {
        if (this == otherSolution) {
            return true;
        }
        if (otherSolution == null || getClass() != otherSolution.getClass()) {
            return false;
        }
        TOPTWSolution object2 = (TOPTWSolution) otherSolution;
        for (int i = 0; i < this.predecessors.length; i++) {
            
            if (this.predecessors[i] != object2.predecessors[i]) {
                return false;
            }
        }
        return true;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(predecessors);
    }
    ...
    /**
     * @brief Obtener informacion de la solucion obtenida
    ...
    /**
     * @brief Evalua la ruta
     * @return double con la ruta evaluada
     */
    ...
    /**
     * @brief Imprime la solucion y devuelve el fitness
     * @return double que es el fitness
     */
