...
public class TOPTWGRASP {
 public static double NO_EVALUATED = -1.0;
    ...
    /**
     * @brief Metodo GRASP
     * @param maxIterations : numero de iteraciones maximas
     * @param maxSizeRCL : tamaño maximo del RCL
     * @return void
     */
    ...
    /**
     * @brief Seleccion difusa en base a un alpha
     * @param rcl
     * @param alpha
     * @return int con la seleccion
     */    
    ...
    /**
     * @brief Metodo para actualizar la solucion
    ...
    /**
     * @brief Devuelve los datos del cliente, ruta, predecesor, coste tiempo y score
     * @param customers
     * @param departureTimes
        ...
        for(int c = 0; c < customers.size(); c++) { // clientes disponibles
            for(int k = 0; k < this.solution.getCreatedRoutes(); k++) { // rutas creadas
                ...
                do {                                                // recorremos la ruta
                    ...
                    if(validFinalInsertion == true && costInsertion < infoCandidate[3]) { // cliente, ruta, predecesor, coste
                        infoCandidate[0] = candidate;
                        infoCandidate[1] = k;
                        infoCandidate[2] = pre;
                        infoCandidate[3] = costInsertion;
                        infoCandidate[4] = this.solution.getProblem().getScore(candidate);
                    }
