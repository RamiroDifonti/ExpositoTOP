...
public class TOPTW {
    ...
    /**
     * @brief Devuelve si es un deposito
     * @param a
     * @return booleano si es o no
     */
    ...
    /**
     * @brief Devuelve la distancia de la ruta
     * @param route
     * @return double con la distancia
     */
    ...
    /**
     * @brief Calcula la distancia de la matriz y lo guarda en distancematrix
     * @return void
     */
    ...
    /**
     * @brief Devuelve el objeto en un formato String
     * @return String con informacion del objeto
     */
    @Override
